...
class Service_Image
{
    ...
    {
        $this->_configuration = new Zend_Config_Ini(APPLICATION_PATH . $this->_configurationFilePath, getenv('APPLICATION_ENV'));
    ...
    protected function _resizeImage()
    {
        ...
        $image = imagecreatefromjpeg($this->_tempFilepath.$this->_originalFilename);
        ...
        $imagePlaceHolder = imagecreatetruecolor($this->_targetWidth, $this->_targetHeight);
        imagecopyresampled($imagePlaceHolder, $image, 0, 0, (int)$cropX, (int)$cropY, $this->_targetWidth, $this->_targetHeight, $cropWidth, $cropHeight);
        imagejpeg($imagePlaceHolder, $this->_imageTargetFilepath.$this->_targetFilename, $this->_targetQuality);
    }
